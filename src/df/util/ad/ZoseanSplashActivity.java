 ...
 * 北京中锐掌讯科技有限公司
 */
public class ZoseanSplashActivity extends Activity {

    public static final String TAG = "df.util.ZoseanSplashActivity";
...
//                    intent.setClass(ZoseanSplashActivity.this,
//                            ZoseanSplashActivity.class);
...
//                    super.handleMessage(msg);
                    ...
                    intent.setClass(ZoseanSplashActivity.this,
                            Colorme.getMainActivityClass(ZoseanSplashActivity.this.getApplicationContext()));
                    startActivity(intent);

                    ZoseanSplashActivity.this.finish();
                    break;
            }
        }
    }
